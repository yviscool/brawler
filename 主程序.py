...
背景图片 = pygame.image.load('assets/images/background/background.jpg').convert_alpha()
...
# 加载精灵地图
# warrior 战士
战士序列图 = pygame.image.load("assets/images/warrior/Sprites/warrior.png").convert_alpha()
# wizard 巫师
巫师序列图 = pygame.image.load("assets/images/wizard/Sprites/wizard.png").convert_alpha()
